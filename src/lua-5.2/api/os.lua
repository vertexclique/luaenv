...
-------------------------------------------------------------------------------
-- Calls the C function exit to terminate the host program. If code is true, the 
-- returned status is EXIT_SUCCESS; if code is false, the returned status is EXIT_FAILURE;
-- if code is a number, the returned status is this number. The default value for code is true.
